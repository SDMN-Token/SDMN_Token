// Website: https://www.sdmntoken.com/
// Telegram: https://t.me/joinchat/IyhIeF1zTz9iMzU0

// Charity Wallet: 0x4453Fc8eA2EfE4c4254A83eAAe2c9dadfE1a7Ce9

// Features:
// 2% of all transcations are automatically redistributed to all holders.
// 6% of all transactions are to the Charity wallet
...
contract SDMNToken is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'SDMN Token';
    string  private constant _SYMBOL = 'SDMN';
    ...
    uint256 private _CHARITY_FEE = 600; // 5% TO CHARITY WALLET
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x4453Fc8eA2EfE4c4254A83eAAe2c9dadfE1a7Ce9, 'We can not exclude Uniswap router.');
    ...
    function setAsCharityAccount(address account) external onlyOwner() {
        require(account != 0x4453Fc8eA2EfE4c4254A83eAAe2c9dadfE1a7Ce9, 'The Uniswap router can not be the charity account.');
    ...
    function _setCharityFee(uint256 charityFee) external onlyOwner() {
        require(charityFee >=0 && charityFee <= 8, 'charityFee should be in 0 - 8');
